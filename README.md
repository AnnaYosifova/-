...
При выполнении упражнения были построены три ансамбля моделей (с использованием стандартизации), а именно PCA_logit, PCA_SVC и PCA_kNN. Лучшей моделью оказалась PCA_SVC, точность которой составила 1.0.
